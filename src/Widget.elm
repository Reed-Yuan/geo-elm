    ...
    let
        ...
        vertView pos colorr = 
            let
                ...
                slideRect = spacer (knotHeight + 10) (width + 20)
            in
        ...
        horizView pos colorr = 
            let
                ...
                slideRect = spacer (width + 20) (knotHeight + 10)
            in
                layers [bar, knot] |> container (width + 20) (knotHeight + 10) (topLeftAt (absolute 10) (absolute 5))
